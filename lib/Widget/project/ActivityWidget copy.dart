...
class _ActivityWidgetState extends State<ActivityWidget> {
  ...
  Future<void> fetchUserNameandTask() async {
    ...
    final userName = await AuthApiService()
        .getUserNameById(widget.actLog.userActionId); // lấy name user action
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      // onTap: () async {
      //   final TaskModel task = await TaskApiService()
      //       .getTaskById(widget.actLog.taskId); // Lấy task từ API
